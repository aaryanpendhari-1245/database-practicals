...
-- SCENARIO OVERVIEW
-- You are hired to create the backend database for an online bookstore. The system must handle books, authors, customers, orders, payments, categories, and delivery agents.
-- You are expected to write MySQL DDL (Data Definition Language) queries to design, manage, and alter the schema.
